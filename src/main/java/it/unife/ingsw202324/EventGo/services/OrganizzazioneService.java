...
public class OrganizzazioneService {
    ...
    /**
     * Crea una nuova organizzazione dopo aver effettuato le verifiche necessarie.
     *
     * @param organizzazione l'istanza di Organizzazione da creare
    ...
    public Organizzazione creaOrganizzazione(Organizzazione organizzazione) {
        ...
        // Verifica se l'IBAN è già in uso
